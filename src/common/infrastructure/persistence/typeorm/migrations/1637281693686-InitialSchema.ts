...
export class InitialSchema1637281693686 implements MigrationInterface {
    name = 'InitialSchema1637281693686'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`travel_plan\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`description\` varchar(100) NOT NULL, \`amount_people\` bigint NULL, \`promotion\` varchar(100) NULL, \`url_image\` varchar(100) NOT NULL,\`traveler_id\` bigint UNSIGNED NOT NULL , PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    }
